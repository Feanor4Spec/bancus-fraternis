...
| P0 | Validacao visual das calculadoras | Revisar os estados de erro, labels e clareza dos campos nas calculadoras mais usadas: Custos Fixos, Reserva, Capacidade, Lance e Compra. | `assets/data/calculadoras.json`, `assets/js/calculadoras-page.js`, `assets/css/platform.css`. | Usuario entende o que preencher, recebe erro por campo e consegue seguir para simulador/trilha sem ambiguidade. |
