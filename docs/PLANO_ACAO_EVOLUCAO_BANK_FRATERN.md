...
| P0 | Erros cross-field das calculadoras | Adicionar alertas de coerencia entre campos, como custos muito acima da renda, reserva insuficiente para lance ou parcela acima da renda. | `assets/js/calculadoras-page.js`, `assets/js/services/calculadoras.service.js`. | Usuario recebe alerta de risco sem impedir cenarios reais de diagnostico. |
