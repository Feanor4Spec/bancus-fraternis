...
| P0 | Prioridade visual da proxima acao | Ajustar os CTAs pos-calculo para destacar o caminho certo conforme o alerta: reduzir custos, montar reserva, calcular capacidade, ir ao simulador ou comparar alternativas. | `assets/js/calculadoras-page.js`, `assets/js/services/calculadoras.service.js`. | O proximo passo muda conforme risco e origem do calculo. |
