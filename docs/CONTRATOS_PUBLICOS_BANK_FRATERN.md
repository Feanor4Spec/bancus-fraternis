...
| Simulador | `data-simulator-readiness`, `data-simulator-decision-strip`, `data-simulator-journey-actions`, `data-simulator-objective-guide`, `data-simulator-objective-card`, `data-simulator-objective-apply`, `data-v8-stagebar`, `data-shelf-col`, `data-shelf-recommendation`, `data-shelf-recommendation-reason`. |
