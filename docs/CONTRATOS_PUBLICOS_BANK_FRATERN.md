...
| `BFBackendApi` | Ponte progressiva para API local Node/SQLite: sessao de backend, usuarios, status tecnico do banco, importacao guiada, gravacao/listagem de eventos, gravacao/listagem de snapshots e fallback estatico. |
