...
| Calculadoras | `data-calculator-form`, `data-calculator-form-alert`, `data-calculator-field`, `data-calculator-field-error`, `data-calculator-result`, `data-calculator-result-mode`, `data-calculator-history`, `data-calculators-hub`, `data-calculator-decision-strip`. |
...
| `tools/validate-calculator-journey.mjs` | Execucao das 19 calculadoras, previa sem persistencia, validacao de formulario, submit persistente e mapa funcional. |
