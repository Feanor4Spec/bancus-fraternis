...
- Dashboard Admin tenta `GET /api/snapshots?limit=30` junto de eventos, status e tabelas; `data-admin-backend-snapshots` lista registros recentes e `data-admin-backend-snapshot` identifica cada item.
