...
- Dashboard Cliente e Dashboard Admin com continuidade, origem, aging, prioridade, propostas versionadas/vencidas, proximos passos, fila guiada executavel, produtividade e carteira por consultor.
