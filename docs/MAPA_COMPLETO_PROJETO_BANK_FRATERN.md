...
| `pages/dashboard-admin.html` | Ativa | Usuarios, recuperacao, pacotes, SLA, roteamento, metas, auditoria e funil. |
...
| `pages/handoff-consultivo.html` | Ativa | Painel consultivo de leads locais. |
...
| Proposta | `data-proposal-acceptance-panel`, `data-proposal-handoff-bridge`. |
