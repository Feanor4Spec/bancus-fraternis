...
[
  ...
  'adminCommercialStageStates',
  'writeAdminCommercialStageStates',
  ...
  'buildAdminCommercialPipelineExport',
  ...
  '__lastAdminCommercialPipelineExport',
...
[
  ...
  '.bf-admin-portfolio-toolbar',
  '.bf-admin-portfolio-priority',
...
const report = {
  ...
  contracts: {
    ...
    commercialPipelineExport: adminUsersJs.includes('bank-fratern.admin-commercial-pipeline.v1'),
